        ...
        <div class="subheader py-3 py-lg-8 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{ route('kasir.produk.info') }}" class="btn btn-primary btn-fixed-height font-weight-bold px-5 px-lg-5 mr-2">
        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom">
                    ...
                    <div class="card-body" id="data_produk">
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    <script>
        ...
        function search_data(page = 1) {
            ...
            $data_produk.html('<div class="text-center"><i class="fa fa-spinner fa-spin fa-fw"></i> Loading</div>');
            $.post('{{ route('kasir.produk.search') }}?page=' + currentPage, {
                _token: '{{ csrf_token() }}',
                paginate: 8
            }, (result) => {
                $data_produk.html(result);
            }).fail((xhr) => {

<table class="table table-stripped">
    ...
    @forelse($user_level as $key => $value)
        <tr>
            ...
            @if(in_array('edit', $action))
                <td class="p-1">
                    <a href="{{ route('pengaturan.user_level.info', 'id=' . $value->id) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon" title="Informasi">

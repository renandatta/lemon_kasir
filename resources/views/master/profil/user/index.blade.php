        ...
        <div class="subheader py-3 py-lg-8 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('master.profil.user.info', $profil->id) }}" class="btn btn-primary btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card card-custom mb-5" id="card_pencarian" style="display: none;">
                            ...
                            <div class="card-body">
                                <form method="post" id="form_pencarian">
                                    ...
                                    <a href="{{ route('master.profil.user', $profil->id) }}" class="btn btn-secondary font-weight-bold ml-2">Reset</a>
                                </form>
                            </div>
                        </div>
                        <div class="card card-custom">
                            ...
                            <div class="card-body pt-2" id="div_data_user">
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    <script>
        ...
        function search_data(page = '') {
            ...
            $.post("{{ route('master.profil.user.search', $profil->id) }}?page=" + selectedPage, {
                _token: '{{ csrf_token() }}',
                paginate: 10,
                action: ['edit'],
                nama: $('#nama').val(),
